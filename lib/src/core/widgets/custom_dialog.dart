...
class CustomDialog extends StatelessWidget {
  ...
  static Future<void> showAlertDialog({
    ...
    await showDialog<bool>(
      context: context,
      barrierColor: AppColors.barrierColor.withValues(alpha: 0.75),
      builder:
          (ctx) => CustomDialog.alert(
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      shape: const RoundedRectangleBorder(borderRadius: Corners.rounded15),
...
class _CustomDialogWithConfirm extends CustomDialog {
  ...
  }) : super._(type: _CustomDialogType.CONFIRM);
}
